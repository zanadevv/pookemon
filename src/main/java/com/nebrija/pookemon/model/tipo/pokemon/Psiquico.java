...
public class Psiquico extends Pokemon {
    ...
    public Psiquico(int id, String nombre, int hp, Habilidad habilidad, Ataque ataque, Ataque ataqueEspecial, Defensa defensa, Defensa defensaEspecial, int velocidad, int dodgeProb, Pokemon strongAgainst, Pokemon weakAgainst, Pokemon synergyWith) {
    ...
    public Psiquico(String nombre, int hp, Habilidad habilidad, Ataque ataque, Ataque ataqueEspecial, Defensa defensa, Defensa defensaEspecial, int velocidad, int dodgeProb, Pokemon strongAgainst, Pokemon weakAgainst, Pokemon synergyWith) {
